...
VL_INLINE_OPT void Vrange::_sequent__TOP__1(Vrange__Syms* __restrict vlSymsp) {
    ...
    if (((1U == vlTOPp->range__DOT__c1__DOT__dout) 
         & (IData)(vlTOPp->range__DOT__running))) {
        vlTOPp->range__DOT__we = 1U;
        if (((IData)(vlTOPp->range__DOT__cgo) | (IData)(vlTOPp->done))) {
...
VL_INLINE_OPT void Vrange::_combo__TOP__3(Vrange__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrange::_combo__TOP__3\n"); );
    Vrange* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vrange::_settle__TOP__4(Vrange__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrange::_settle__TOP__4\n"); );
    Vrange* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (((1U == vlTOPp->range__DOT__c1__DOT__dout) 
         & (IData)(vlTOPp->range__DOT__running))) {
